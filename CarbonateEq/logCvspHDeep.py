...
n_steps = 100
pH_increasing = np.linspace(pH_start, pH_end, n_steps)


pyco2_kws["par1"] = 2100  # DIC we are using as an example
...
# See how species concentrations change as a function of pH, concentrations in mol per kg
...
DIC = np.log10(CO2dict_response["dic"]/1e6)
