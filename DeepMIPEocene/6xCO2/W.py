...
path1='/home/kgemmell/weathering/DeepMIP/6xCO2/6xCO2tsDeepMIP.nc'
d1=Dataset(path1,'r')
TS=d1.variables['ts'][:,:,:]
...
path2='/home/kgemmell/weathering/DeepMIP/6xCO2/6xCO2PrecDeepMIP.nc'
d2=Dataset(path2,'r')
Pr=d2.variables['pr'][:,:,:]
...
#plt.title('DeepMIP 6x $CO_2$ Weathering (Homogeneous Lithology)')
