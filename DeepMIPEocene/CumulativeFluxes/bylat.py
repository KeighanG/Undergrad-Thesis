...
plt.plot(np.flip(lat[0:48]),np.cumsum(np.flip(CumulativeLand[0:48])+CumulativeLand[48:])/np.sum(CumulativeLand)*100,':m',label='Land')
...
plt.ylabel('Cumulative Flux/Land (%)',fontsize=14)
