...
path1='/home/kgemmell/weathering/DeepMIP/9xCO2/9xCO2tsDeepMIP.nc'
d1=Dataset(path1,'r')
TS=d1.variables['ts'][:,:,:]
...
path2='/home/kgemmell/weathering/DeepMIP/9xCO2/9xCO2PrecDeepMIP.nc'
d2=Dataset(path2,'r')
Pr=d2.variables['pr'][:,:,:]
...
ttomol=(10**6)/12.011 #(g/t)/(g/mol)of C = mol C
...
fig=plt.contourf(lon,lat,F,norm=colors.LogNorm(),levels=np.logspace(-4,np.log10(np.nanmax(F)+1),100),cmap='viridis')
#plt.title('DeepMIP 9x $CO_2$ Weathering (Homogeneous Lithology)',fontsize=20)
