...
Ea[Ea==14]=0
Ea[Ea==15]=0 #No data
Ea[Ea==16]=0 #Ice and Glaciers, no weathering
...
F0=5*10**12/A2 #mol/yr/m^2 from Colbourn
C0=280#ppm
Ea=Ea#J/mol
Rc=8.314 #J/mol/K
...
#Equations
#Pterm8=((2*(co28/C0))/(1+(co28/C0)))**0.4
Pterm8=(co28/C0)**0.5
...
path='/home/czg/FYSP_clouds_archive/CAM4/cam4_11.nc'
d=Dataset(path,'r')
...
fig=plt.contourf(lon1,lat1,F,norm=colors.LogNorm(),levels=np.logspace(-4.5,np.log10(np.nanmax(F8)+1),200),cmap='viridis')
#plt.title('$S/S_o$=1.1 Weathering Flux',fontsize=20)
plt.show()
