...
#------------------------------------------------------------------------------#
#Read in Data
path='/home/kgemmell/weathering/CESM/4xCO2/TS.nc'
d=Dataset(path,'r')
lat=d.variables['lat'][:]
lon=d.variables['lon'][:]
TS=d.variables['ts'][:,:,:]
...
path1='/home/kgemmell/weathering/CESM/4xCO2/Runoff.nc'
d1=Dataset(path1,'r')
...
T0=287.1968543493361 #Reference temperature from control run
...
plt.title('CESM Abrupt 4xCO2 Homogeneous Lithology Weathering')
...
plt.show()
plt.savefig('4xHomogeneousMap.png')
